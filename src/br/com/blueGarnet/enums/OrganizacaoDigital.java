...
public class OrganizacaoDigital {
	...
	public enum SocContrato {
		CONTRATO_SOCIAL("001","Contrato Social"),
			ALTERACAO_CONTRATUAL("002","Alteração Contratual"),
				REQ_EMPRESARIO("003","Req. de Empresário (Original)"),
					REG_FIRMA_INDV("004","Reg. de Firma Individual (Const./Alter.)");
			...
			CONTRATO_LOCACAO("002","Contrato de Locação"),
				PROTOC_ENTREGA("003","Protocolo de Entrega"),
					MEMO_REUNIOES("004","Memória de Reuniões"),
						RELACAO_DOC_RECEBIDOS("005","Relação de Documentos Recebidos"),
							RELACAO_DOC_FALTA("006","Relação de Faltas de Documentos ");
